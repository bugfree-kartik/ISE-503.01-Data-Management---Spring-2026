-- =====================================================================
-- SBU Dining System — PostgreSQL Seed Data
-- Boolean values use TRUE/FALSE (PostgreSQL-compatible)
-- =====================================================================

-- 1. MealPlan (5)
INSERT INTO MealPlan VALUES (1, 'Platinum',  3200.00, 999, 200.00, 'Spring 2026');
...
-- 6. MenuItem (45) — booleans as TRUE/FALSE
INSERT INTO MenuItem VALUES (1,  'Cheeseburger',              'Entree',    750, 8.50,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (2,  'Margherita Pizza Slice',    'Entree',    320, 4.25,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (3,  'Pepperoni Pizza Slice',     'Entree',    380, 4.75,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (4,  'Grilled Chicken Sandwich',  'Entree',    580, 9.00,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (5,  'Veggie Burger',             'Entree',    520, 8.75,  TRUE,  TRUE,  FALSE);
INSERT INTO MenuItem VALUES (6,  'Caesar Salad',              'Salad',     420, 7.50,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (7,  'Garden Salad',              'Salad',     180, 6.50,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (8,  'Quinoa Power Bowl',         'Entree',    540, 10.50, TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (9,  'Spaghetti Marinara',        'Entree',    620, 8.25,  TRUE,  TRUE,  FALSE);
INSERT INTO MenuItem VALUES (10, 'Fettuccine Alfredo',        'Entree',    810, 9.50,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (11, 'Mongolian Beef',            'Entree',    690, 11.00, FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (12, 'Vegetable Stir Fry',        'Entree',    430, 9.25,  TRUE,  TRUE,  FALSE);
INSERT INTO MenuItem VALUES (13, 'Chicken Tacos (3)',         'Entree',    560, 8.75,  FALSE, FALSE, TRUE);
INSERT INTO MenuItem VALUES (14, 'Black Bean Burrito',        'Entree',    640, 8.50,  TRUE,  TRUE,  FALSE);
INSERT INTO MenuItem VALUES (15, 'California Roll',           'Entree',    320, 9.50,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (16, 'Spicy Tuna Roll',           'Entree',    340, 11.00, FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (17, 'Tonkotsu Ramen',            'Entree',    780, 12.50, FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (18, 'Pork Bao (2)',              'Appetizer', 320, 7.00,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (19, 'Chicken Shawarma Plate',    'Entree',    720, 11.50, FALSE, FALSE, TRUE);
INSERT INTO MenuItem VALUES (20, 'Falafel Wrap',              'Entree',    580, 8.50,  TRUE,  TRUE,  FALSE);
INSERT INTO MenuItem VALUES (21, 'Chicken Tikka Masala',      'Entree',    650, 11.00, FALSE, FALSE, TRUE);
INSERT INTO MenuItem VALUES (22, 'Chana Masala',              'Entree',    480, 9.50,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (23, 'Beef Pho',                  'Entree',    560, 11.50, FALSE, FALSE, TRUE);
INSERT INTO MenuItem VALUES (24, 'Veggie Pho',                'Entree',    420, 10.50, TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (25, 'French Fries',              'Side',      380, 3.50,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (26, 'Onion Rings',               'Side',      410, 4.00,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (27, 'Steamed Broccoli',          'Side',       80, 3.25,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (28, 'Mashed Potatoes',           'Side',      220, 3.50,  TRUE,  FALSE, TRUE);
INSERT INTO MenuItem VALUES (29, 'Tomato Soup',               'Soup',      180, 4.50,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (30, 'Chicken Noodle Soup',       'Soup',      210, 5.00,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (31, 'New England Clam Chowder',  'Soup',      320, 5.75,  FALSE, FALSE, FALSE);
INSERT INTO MenuItem VALUES (32, 'Chocolate Chip Cookie',     'Dessert',   220, 2.50,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (33, 'Brownie',                   'Dessert',   310, 3.00,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (34, 'Cheesecake Slice',          'Dessert',   420, 5.50,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (35, 'Vanilla Ice Cream Cup',     'Dessert',   180, 3.50,  TRUE,  FALSE, TRUE);
INSERT INTO MenuItem VALUES (36, 'Vegan Chocolate Mousse',    'Dessert',   240, 4.50,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (37, 'Iced Coffee',               'Beverage',   90, 3.75,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (38, 'Caramel Latte',             'Beverage',  280, 5.25,  TRUE,  FALSE, TRUE);
INSERT INTO MenuItem VALUES (39, 'Green Tea',                 'Beverage',    5, 2.50,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (40, 'Strawberry Smoothie',       'Beverage',  220, 5.75,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (41, 'Bottled Water',             'Beverage',    0, 1.75,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (42, 'Coca-Cola',                 'Beverage',  140, 2.25,  TRUE,  TRUE,  TRUE);
INSERT INTO MenuItem VALUES (43, 'Plain Bagel with Cream Cheese','Entree', 380, 4.50,  TRUE,  FALSE, FALSE);
INSERT INTO MenuItem VALUES (44, 'Avocado Toast',             'Entree',    340, 7.50,  TRUE,  TRUE,  FALSE);
INSERT INTO MenuItem VALUES (45, 'Buffalo Wings (8)',         'Appetizer', 720, 9.50,  FALSE, FALSE, TRUE);
...
-- 8. ItemAllergen (60)
INSERT INTO ItemAllergen VALUES (1,  3);
INSERT INTO ItemAllergen VALUES (1,  6);
INSERT INTO ItemAllergen VALUES (2,  3);
INSERT INTO ItemAllergen VALUES (2,  6);
INSERT INTO ItemAllergen VALUES (3,  3);
INSERT INTO ItemAllergen VALUES (3,  6);
INSERT INTO ItemAllergen VALUES (4,  6);
INSERT INTO ItemAllergen VALUES (5,  6);
INSERT INTO ItemAllergen VALUES (5,  5);
INSERT INTO ItemAllergen VALUES (6,  3);
INSERT INTO ItemAllergen VALUES (6,  4);
INSERT INTO ItemAllergen VALUES (6,  7);
INSERT INTO ItemAllergen VALUES (6,  6);
INSERT INTO ItemAllergen VALUES (9,  6);
INSERT INTO ItemAllergen VALUES (10, 3);
INSERT INTO ItemAllergen VALUES (10, 6);
INSERT INTO ItemAllergen VALUES (11, 5);
INSERT INTO ItemAllergen VALUES (11, 6);
INSERT INTO ItemAllergen VALUES (11, 9);
INSERT INTO ItemAllergen VALUES (12, 5);
INSERT INTO ItemAllergen VALUES (12, 9);
INSERT INTO ItemAllergen VALUES (13, 3);
INSERT INTO ItemAllergen VALUES (14, 6);
INSERT INTO ItemAllergen VALUES (15, 7);
INSERT INTO ItemAllergen VALUES (15, 8);
INSERT INTO ItemAllergen VALUES (15, 5);
INSERT INTO ItemAllergen VALUES (16, 7);
INSERT INTO ItemAllergen VALUES (16, 5);
INSERT INTO ItemAllergen VALUES (17, 4);
INSERT INTO ItemAllergen VALUES (17, 6);
INSERT INTO ItemAllergen VALUES (17, 5);
INSERT INTO ItemAllergen VALUES (18, 6);
INSERT INTO ItemAllergen VALUES (18, 5);
INSERT INTO ItemAllergen VALUES (19, 9);
INSERT INTO ItemAllergen VALUES (20, 6);
INSERT INTO ItemAllergen VALUES (20, 9);
INSERT INTO ItemAllergen VALUES (21, 3);
INSERT INTO ItemAllergen VALUES (23, 5);
INSERT INTO ItemAllergen VALUES (24, 5);
INSERT INTO ItemAllergen VALUES (26, 6);
INSERT INTO ItemAllergen VALUES (28, 3);
INSERT INTO ItemAllergen VALUES (29, 3);
INSERT INTO ItemAllergen VALUES (30, 4);
INSERT INTO ItemAllergen VALUES (30, 6);
INSERT INTO ItemAllergen VALUES (31, 3);
INSERT INTO ItemAllergen VALUES (31, 8);
INSERT INTO ItemAllergen VALUES (32, 3);
INSERT INTO ItemAllergen VALUES (32, 4);
INSERT INTO ItemAllergen VALUES (32, 6);
INSERT INTO ItemAllergen VALUES (33, 3);
INSERT INTO ItemAllergen VALUES (33, 4);
INSERT INTO ItemAllergen VALUES (33, 6);
INSERT INTO ItemAllergen VALUES (34, 3);
INSERT INTO ItemAllergen VALUES (34, 4);
INSERT INTO ItemAllergen VALUES (34, 6);
INSERT INTO ItemAllergen VALUES (35, 3);
INSERT INTO ItemAllergen VALUES (38, 3);
INSERT INTO ItemAllergen VALUES (43, 3);
INSERT INTO ItemAllergen VALUES (43, 6);
INSERT INTO ItemAllergen VALUES (45, 3);
